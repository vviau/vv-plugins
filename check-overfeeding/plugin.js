...
arc.run(['$rootScope', function ($rootScope) {
   ...
   $rootScope.plugin("arcCheckOverFeeding", "Check Overfeeding", "page", {
      menu: "tools",
      icon: "fa-users",
...
arc.directive("arcCheckOverFeeding", function () {
   return {
      restrict: "EA",
      replace: true,
      scope: {
      ...
      templateUrl: "__/plugins/check-overfeeding/template.html",
      ...
      controller: ["$scope", "$rootScope", "$http", "$tm1", "$translate", "$timeout", "ngDialog", function ($scope, $rootScope, $http, $tm1, $translate, $timeout, ngDialog) {
         ...
         $scope.openModal = function () {
            var dialog = ngDialog.open({
               ...
               template: "__/plugins/check-overfeeding/m-overfeeding.html",
               name: "Instances",
               scope: $scope,
         ...
         $scope.$on("close-tab", function (event, args) {
            ...
            if (args.page == "arcCheckOverFeeding" && args.instance == $scope.instance && args.name == null) {
