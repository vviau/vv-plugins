...
arc.run(['$rootScope', function ($rootScope) {
    ...
    $rootScope.plugin("cubewiseMdxOld", "MDX Old", "page", {
        menu: "tools",
        icon: "fa-table",
...
arc.directive("cubewiseMdxOld", function () {
    return {
        restrict: "EA",
        replace: true,
        scope: {
        ...
        templateUrl: "__/plugins/mdx-old/template.html",
        ...
        controller: ["$scope", "$rootScope", "$http", "$tm1", "$translate", "$timeout", function ($scope, $rootScope, $http, $tm1, $translate, $timeout) {
            ...
            $scope.$on("close-tab", function (event, args) {
                ...
                if (args.page == "cubewiseMdxOld" && args.instance == $scope.instance && args.name == null) {
